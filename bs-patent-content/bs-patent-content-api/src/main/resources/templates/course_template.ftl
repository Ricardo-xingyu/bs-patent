...
<head>
    ...
    <title>专利审核系统-${model.courseBase.name}</title>
...
<#--                </span>-->
        ...
        <div class="banner-rit">
            <p>
                <a href="http://www.bs.cn/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">
                    <#if model.courseBase.pic??>
                        <img src="http://file.bs.cn${model.courseBase.pic}" alt="" width="270" height="156">
                    <#else>
...
<div class="article-cont">
    <div class="tit-list">
        <a href="javascript:;" id="articleClass" class="active">专利介绍</a>
                ...
                <div class="article-left-box">
                    <div class="content">
                        ...
                        <div class="content-com course">
                            <div class="title"><span>专利制作</span></div>
                            <div class="cont">
                        ...
                        <div class="content-com prob">
                            ...
                            <div class="cont">
                                <ul>
                                    <li class="item"><span class="on-off"><i class="i-chevron-bot"></i> 我什么时候能够访问专利视频与作业？</span>
                                        <div class="drop-down">
                                            <p>专利安排灵活，专利费用支付提供180天全程准入和资格证书。自定进度专利建议的最后期限，但你不会受到惩罚错过期限，只要你赚你的证书在180天内。以会话为基础的专利可能要求你在截止日期前保持正轨，但如果你落后了，你可以切换到以后的会议，你完成的任何工作将与你转移。</p>
                                        </div>
                                    </li>
                                    <li class="item"><span class="on-off"><i class="i-chevron-bot"></i> 如何需要额外的时间来完成专利会怎么样？</span>
                                        <div class="drop-down">
                                            <p>专利安排灵活，专利费用支付提供180天全程准入和资格证书。自定进度专利建议的最后期限，但你不会受到惩罚错过期限，只要你赚你的证书在180天内。以会话为基础的专利可能要求你在截止日期前保持正轨，但如果你落后了，你可以切换到以后的会议，你完成的任何工作将与你转移。</p>
                                        </div>
                                    </li>
                                    <li class="item"><span class="on-off"><i class="i-chevron-bot"></i> 我支付次专利之后会得到什么？</span>
                                        <div class="drop-down">
                                            <p>专利安排灵活，专利费用支付提供180天全程准入和资格证书。自定进度专利建议的最后期限，但你不会受到惩罚错过期限，只要你赚你的证书在180天内。以会话为基础的专利可能要求你在截止日期前保持正轨，但如果你落后了，你可以切换到以后的会议，你完成的任何工作将与你转移。</p>
                                        </div>
                                    </li>
...
<#--                                            <li><a href="http://www.bs.cn/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target="_blank">${secondNode.pname}</a></li>-->
<#--                                        </#list>-->
<#--                                    </ul>-->
<#--                                </div>-->
<#--                            </div>-->
...
<#--                            <div class="about">使用Java消息中间件处理异步消息成为了分布式系统中的必修课，通过本门专利可以深入浅出的学习如何在Java中使用消息中间件并且一步一步打造更优雅的最佳实践方案。</div>-->
<#--                            <div class="drop-down" style="height: 260px;">-->
<#--                                <ul class="list-box">-->
...
<#--        <div class="mask"></div>-->
<#--        <!--欢迎访问专利弹窗- start &ndash;&gt;-->
<#--        <div class="popup-course-box">-->
<#--            <div class="title">${model.courseBase.name} <span class="close-popup-course-box">×</span></div>-->
<#--            <div class="content">-->
<#--                <p>欢迎学习本专利，本专利免费您可以立即学习，也可加入我的专利表享受更优质的服务。</p>-->
<#--                <p><a href="#" @click.prevent="addCourseTable()">加入我的专利表</a>  <a href="#" @click.prevent="startLearngin()">立即学习</a></p>-->
<#--            </div>-->
<#--        </div>-->
<#--    </div>-->
<#--    <div class="popup-box">-->
...
<#--                <div class="info">-->
<#--                    <p class="info-tit">${model.courseBase.name}<span>专利有效期:${model.courseBase.validDays}天</span></p>-->
<#--                    <p class="info-pic">专利价格 : <span>￥${model.courseBase.originalPrice!''}元</span></p>-->
